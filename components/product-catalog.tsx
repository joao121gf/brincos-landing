...
const products = [
  ...
  },
  {
    ...
    rating: 4.9,
    reviews: 80,
    description: "Argola moderna em ouro 18k, ideal para o dia a dia com sofisticação.",
  },
  {
    id: 3,
    ...
    rating: 4.9,
    reviews: 80,
    description: "Brinco luxuoso com cristais Swarovski, brilho incomparável.",
  },
  {
    id: 4,
    ...
    rating: 4.9,
    reviews: 80,
    description: "Design em gota com acabamento refinado, versatilidade garantida.",
  },
]
